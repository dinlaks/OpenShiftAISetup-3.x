...
spec:
  ...
  - name: app
    ...
    - |
      ...
      echo "" | tee -a /data/test.txt
      echo "✅ SUCCESS! Pod 1 can write to EFS!" | tee -a /data/test.txt
      echo ""
...
spec:
  ...
  - name: app
    ...
    - |
      ...
      echo "========================================"
      echo ""
      echo "✅ Pod 2 successfully accessed shared storage at \$(date)" | tee -a /data/test.txt
      echo ""
